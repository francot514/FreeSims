...
namespace TSO.Content
{
    ...
    public class WorldObjectProvider : IContentProvider<GameObject>
    {
        ...
        public void Init()
        {
            ...
            string path = System.Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "\\TSO Ville\\Downloads\\";
        ...
        public GameObject Get(ulong id)
        {
            lock (Cache)
            {
                ...
                if (iff == null)
                {
                    ...
                    string path = System.Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "\\TSO Ville";
                    iff = new Iff(path + "\\Downloads\\" + reference.FileName + ".iff");
