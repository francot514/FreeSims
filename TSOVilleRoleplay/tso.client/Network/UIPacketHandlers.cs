...
namespace TSOVille.Network
{
    ...
    public class UIPacketHandlers
    {
        ...
        public static CharacterCreationStatus OnCharacterCreationStatus(NetworkClient Client, ProcessedPacket Packet)
        {
            ...
            lock(TSOVille.Code.GameFacade.CDataRetriever.LotTileData)
                TSOVille.Code.GameFacade.CDataRetriever.LotTileData = TileEntries;
        ...
        public static LotTileEntry OnPlayerJoinedSession(NetworkClient Client, ProcessedPacket Packet)
        {
            ...
            if (HasHouse != 0)
            {
                ...
                LotTileEntry[] TileEntries = new LotTileEntry[TSOVille.Code.GameFacade.CDataRetriever.LotTileData.Length + 1];
                TileEntries[0] = TileEntry;
                TSOVille.Code.GameFacade.CDataRetriever.LotTileData.CopyTo(TileEntries, 1);
            }
        ...
        public static void OnPlayerReceivedLetter(NetworkClient Client, ProcessedPacket Packet)
        {
            ...
            Code.UI.Panels.MessageAuthor Author = new TSOVille.Code.UI.Panels.MessageAuthor();
            Author.Author = From;
