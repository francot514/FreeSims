...
namespace TSOVille.Network
{
    ...
    public delegate void OnPlayerJoinedDelegate(TSOVille.Code.Rendering.City.LotTileEntry TileEntry);
    ...
    public class NetworkController
    {
        ...
        {
            TSOVille.Code.Rendering.City.LotTileEntry TileEntry = UIPacketHandlers.OnPlayerJoinedSession(Client, Packet);
