...
namespace TSOVille
{
    ...
    public class TSOGame : TSO.Common.rendering.framework.Game
    {
        ...
        protected override void Initialize()
        {
            ...
            GameFacade.SoundManager = new TSOVille.Code.Sound.SoundManager();
        ...
        protected override void LoadContent()
        {
            ...
            {
                System.Windows.Forms.MessageBox.Show("Content could not be loaded. Make sure that the Project Dollhouse content has been compiled! (ContentSrc/TSOVilleContent.mgcb)");
                Exit();
            }
