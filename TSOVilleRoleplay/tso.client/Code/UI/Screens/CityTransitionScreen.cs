...
namespace TSOVille.Code.UI.Screens
{
    public class CityTransitionScreen : GameScreen
    {
        ...
        {
            TSOVille.Network.Events.ProgressEvent Progress = 
                new TSOVille.Network.Events.ProgressEvent(TSOVille.Events.EventCodes.PROGRESS_UPDATE);
            Progress.Done = 1;
            Progress.Total = 3;
        ...
        private void Controller_OnCityTransfer(CityTransferStatus e)
        {
            switch (e)
            {
                case CityTransferStatus.Success:
                    ...
                    TSOVille.Network.Events.ProgressEvent Progress = new ProgressEvent(EventCodes.PROGRESS_UPDATE);
                    Progress.Done = 2;
                    Progress.Total = 3;
        ...
        private void Controller_OnNetworkError(SocketException Exception)
        {
            ...
            alert.ButtonMap[UIAlertButtons.OK].OnButtonClick += new TSOVille.LUI.ButtonClickDelegate(ErrorReturnAlert);
            /** Reset **/
