        ...
        public Outfit Head
        {
            get
            {
                if (Avatar.Head == null)
                {
                    ...
                    {
                        var alert = UIScreen.ShowAlert(new UIAlertOptions { Title = "Error", Message = "Failed to find head with ID: " + m_HeadOutfitID }, false);
        ...
        public Outfit Body
        {
            get
            {
                if (Avatar.Body == null)
                {
                    ...
                    {
                        var alert = UIScreen.ShowAlert(new UIAlertOptions { Title = "Error", Message = "Failed to find body with ID: " + m_BodyOutfitID }, false);
