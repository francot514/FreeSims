...
namespace TSOVille.Code
{
    ...
    public class GameController
    {
        ...
        public void ShowPersonCreation(CoreGameScreen GameScreen)
        {
            var screen = new PersonSelectionEdit();
            screen.MainScreen = GameScreen;
            //screen.SelectedCity = selectedCity;
            GameFacade.Screens.RemoveCurrent();
            GameFacade.Screens.AddScreen(screen);
        }

        public void ShowHouseCreation(CoreGameScreen GameScreen)
        {
            var screen = new HouseCreator();
            screen.MainScreen = GameScreen;
            //screen.SelectedCity = selectedCity;
            GameFacade.Screens.RemoveCurrent();
            GameFacade.Screens.AddScreen(screen);
