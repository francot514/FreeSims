...
namespace TSOVille {
    ...
    internal sealed partial class GlobalSettings : global::System.Configuration.ApplicationSettingsBase {
        ...
        public void SaveTo(string path)
         {
            System.IO.StreamWriter writer = new System.IO.StreamWriter(path + "Settings.xml");
            writer.WriteLine("Username=" + GlobalSettings.Default.LastUser);
            writer.WriteLine("Password=" +  GlobalSettings.Default.LastPass);
            writer.WriteLine("Windowed=" + GlobalSettings.Default.Windowed);
            writer.Close();
