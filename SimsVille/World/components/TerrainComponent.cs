...
namespace FSO.LotView.Components
{
    ...
    public class TerrainComponent : WorldComponent, IDisposable
    {
        ...
        public TerrainComponent(Rectangle size, Blueprint blueprint) {
            ...
            this.Bp = blueprint;
            GridAsTexture = FSOEnvironment.Linux;
        ...
        public override void Draw(GraphicsDevice device, WorldState world){
            ...
            var cam2d = (WorldCamera)world.Camera;
            var rot =( ((WorldCamera)(world.Camera)).RotateOff/ 180) * Math.PI;
            ...
            Bp.FloorComp.Draw(device, world);
            ...
            var primitives = Bp.FloorComp.SetGrassIndices(device, Effect, world);
            ...
            if (primitives > 0)
            {
                ...
                if (GridPrimitives > 0 && world.BuildMode > 0)
                {
                    ...
                    if (GridAsTexture)
                    {
                        ...
                        Effect.DiffuseColor = 
                            Content.Content.Get().TS1Global != null ?
        ...
        public void DrawMask(GraphicsDevice gd, WorldState world, Matrix view, Matrix projection)
        {
            ...
            //{
                ...
                var pass = Effect.CurrentTechnique.Passes[0];
                pass.Apply();
                var primitives = Bp.FloorComp.SetGrassIndices(gd, Effect, world);
