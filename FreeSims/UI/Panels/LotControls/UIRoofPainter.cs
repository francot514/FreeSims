...
{
    public class UIRoofPainter : UICustomLotControl
    {
        ...
        public UIRoofPainter(VM vm, World world, UILotControl parent, List<int> parameters)
        {
        ...
        public void MouseUp(UpdateState state)
        {
            ...
            vm.Context.Architecture.RunCommands(Commands, true);
            Commands.Clear();
            Drawing = false;
        }
